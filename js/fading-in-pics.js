function isScrolledIntoView(elem){ // a function that tells whether an element is in view after scrolling into it
...
function chnageOpacity(){ // a function that changes the opacity of an element once it has scrolled into view
